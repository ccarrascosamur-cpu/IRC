...
// cms-site/worker/index.js
var REPO = "ccarrascosamur-cpu/IRC";
var BRANCH = "main";
var DATA_PATH = "cms-site/data";
var index_default = {
...
async function handleLogin(request, env) {
  ...
  return jsonResponse({ error: "Contrase\xF1a incorrecta" }, 401);
}
